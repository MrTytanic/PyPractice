...
area_code_list = {
    ...
    "California": ["209", "213", "310", "323", "408", "415", "510", "530", "559", "562", "619", "626", "650", "661", "707", "714", "760", "805", "818", "831", "858", "909", "916", "925", "949"],
...
while True:
    ...
    if state in area_code_list:
        area_codes = area_code_list[state]
        area_code = random.choice(area_codes)  # Randomly select an area code

        # Generate random first and last parts of the phone number
        ...
        phone_num = phone_number(country_code, area_code, first, last)
        print(f"Generated phone number: {phone_num}")
    else:
        print("State not found in the area code list.")
